        ...
        <div>
          ...
          <Container backgroundColor={colors.primary} minHeight="100vh" pX="2rem" pTop="1rem" pBottom="4rem">
            ...
            <Grid cols={2} gap="2rem" alignItems="center">
              <Content pLeft="12rem" color="white" fontFamily="Cantata One" lineHeight="177%" fontSize="1rem">
                I grew up in a place which were not surrounded by big and noisy cities but by vast fields and empty
                land. Yes, it&rsquo;s countryside. Therefore, my designs, beside my imagination, has something to do
                with the greenness of the urban and the peacefulness within.
                <br />I suppose such placidness and rusticity can positively affect products. People tend to travel to
                somewhere with lots of plants or open space to get some fresh air, temporary forget about their worries.
                I believe allowing people to find such feelings in my products
              </Content>
              <ImageContainer />
            </Grid>
          </Container>
